defmodule JswatchWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(JswatchWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(JswatchWeb.Gettext, "errors", msg, opts)
    end
  end
